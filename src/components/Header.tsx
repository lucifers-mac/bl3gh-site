      ...
      <div className="max-w-6xl mx-auto px-6 h-14 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-8">
          ...
          >
            ...
            <span className="snipcart-items-count absolute -top-2 -right-2 bg-[#f0f0f0] text-black text-xs rounded-full w-5 h-5 flex items-center justify-center font-medium hidden"></span>
          </button>
        </nav>
