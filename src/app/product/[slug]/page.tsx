      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        <div>
          ...
          {product.colorways.length > 1 && (
            <div className="mb-6">
              <label className="text-xs tracking-wider text-[#707070] uppercase block mb-3">Color</label>
              <div className="flex items-center gap-3">
                {product.colorways.map((c, i) => (
                  <button
                    key={c.name}
                    className={`w-10 h-10 rounded-full border-2 transition-colors ${
                      i === 0 ? "border-[#f0f0f0]" : "border-[#333] hover:border-[#666]"
                    }`}
          ...
          {/* Sizes */}
          <div className="mb-8">
            <label className="text-xs tracking-wider text-[#707070] uppercase block mb-3">Size</label>
